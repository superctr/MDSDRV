...
2. [.MDS binary file format](#mds-binary-file-format)
	2.1. [.MDS file header (version 0)](#mds-file-header-version-0)
	2.2. [Sequence data chunk](#sequence-data-chunk)
	2.3. [Data block list chunk](#data-block-list-chunk)
		2.3.1 [Global data block subchunk](#global-data-block-subchunk)
		2.3.2 [PCM data block subchunk](#pcm-data-block-subchunk)
...
5. [Sequence data format](#sequence-data-format)
	5.1. [Using Drum mode](#using-drum-mode)
	5.2. [Using FM3 special mode](#using-fm3-special-mode)
...
- `fb dd(ub)` - `lpf`
	Loop finish. `dd` is the loop count, a value of `00` or `ff`
